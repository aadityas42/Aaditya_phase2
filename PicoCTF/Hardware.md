...
- I installed the logic 2 software after looking at the .sal extension of the file we are given.
- After this, I analysed the file in it, and put a filter for UART which is known as async serial in logic2. Then I analysed the D3 channel since its the only one with any signals.
- <img width="1828" height="1018" alt="image" src="https://github.com/user-attachments/assets/931ad6f0-27e8-4157-ac7f-544f26fb8e11" />

- Looking at the output for this in the terminal, it displays a large piece of text:
...
- I learned how to analyse logic circuits using logic2.
